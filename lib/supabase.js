...
// Credentials are set by lib/config.js (loaded via <script> before this module).
// The fallback literals here are only for environments where config.js hasn't run
// (e.g. direct node import during local testing). To update the project credentials,
// edit lib/config.js — that is the single source of truth.
const SUPABASE_URL      = (typeof window !== 'undefined' && window.__SB_URL)      || 'https://ivgathdwiptuymrqzruq.supabase.co';
const SUPABASE_ANON_KEY = (typeof window !== 'undefined' && window.__SB_ANON_KEY) || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml2Z2F0aGR3aXB0dXltcnF6cnVxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzkzODkzMjYsImV4cCI6MjA5NDk2NTMyNn0.cp30eXfoqrESRRzInQLcoierU-Qup4HNAHxPsu21aJ8';
