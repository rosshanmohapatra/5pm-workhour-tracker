...
- **Plan Days** - mark any day as Half Day, Full Day Leave, or Holiday.
- **Plan Weeks** - schedule early leave or late stay for future days.
- **Penalty Calculation** - tracks days/weeks where you fell short and surfaces a makeup owed.
- **Plan Leave Timings** - set a personal out-time target per day (e.g. "I need to leave by 4 PM today").
- **Edit Sessions** - edit login/logout retroactively with overlap prevention.
- **Auto-Stop Protection** - prevents runaway tracking past a configurable cap. 1 hour Past daily target.
- **Smart Notifications** - smart reminders when you hit target, when overtime kicks in, when a deficit builds.
- **Data import/export** - full JSON backup and restore along with auto sync.
- **Quick Setup** - Enter Name & Position, setup routine, done.
